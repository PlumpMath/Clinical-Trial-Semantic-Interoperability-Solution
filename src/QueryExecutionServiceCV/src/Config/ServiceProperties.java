...
public class ServiceProperties {
	...
	public static String getServiceVendor (String path) {
		try {
			Properties prop = new Properties();
		    String fileName = path;
		    InputStream is = new FileInputStream(fileName);
			...
			prop.load(is);
			String res = prop.getProperty("service_vendor");
			//System.out.println(res);
			return res;
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public static String getCDM (String path) {
		try {
			Properties prop = new Properties();
		    String fileName = path;
		    InputStream is = new FileInputStream(fileName);
			...
			prop.load(is);
			String res = prop.getProperty("CDM");
			//System.out.println(res);
			return res;
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public static String getCDMVersion (String path) {
		try {
			Properties prop = new Properties();
		    String fileName = path;
		    InputStream is = new FileInputStream(fileName);
			...
			prop.load(is);
			String res = prop.getProperty("CDM_version");
			//System.out.println(res);
			return res;
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public static String getQueryLanguage (String path) {
		try {
			Properties prop = new Properties();
		    String fileName = path;
		    InputStream is = new FileInputStream(fileName);
			...
			prop.load(is);
			String res = prop.getProperty("query_language");
			//System.out.println(res);
			return res;
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	public static String getQueryLanguageVersion (String path) {
		try {
			Properties prop = new Properties();
		    String fileName = path;
		    InputStream is = new FileInputStream(fileName);
			...
			prop.load(is);
			String res = prop.getProperty("query_language_version");
			//System.out.println(res);
			return res;
		} catch (IOException e) {
			// TODO Auto-generated catch block
